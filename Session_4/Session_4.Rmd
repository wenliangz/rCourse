...
To find the number of influenza events, broken down by month and type of event, across the whole country, we can use `aggregate()`.  
...
If we'd like to also break this down to the state level, we can add "state" to the formula.  
...
To see the average number of events, across all states, including the standard error, we can do:  
