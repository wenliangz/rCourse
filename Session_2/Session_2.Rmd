...
opts_chunk$set(message=FALSE, warning=FALSE, comment = "", tidy = T, width = 60)
options(width = 60)
```
...
Session_1[1,1] == Session_1[2,1]  
```   
Turns out that the data in rows 1 and 2 both belong to Subject 1! Good thing we checked :-)  
